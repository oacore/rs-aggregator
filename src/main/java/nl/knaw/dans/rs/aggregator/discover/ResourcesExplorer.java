 ...
 * @since 30/03/2017
 */
public class ResourcesExplorer extends AbstractUriExplorer{
    private final ResourceSyncContext rsContext;

    public ResourcesExplorer(CloseableHttpClient httpClient, ResourceSyncContext rsContext) {
        super(httpClient);
            ...
            for (RsItem item : itemList) {
                ...
                if (childLink != null && !index.contains(childLink)) {
                    try {
                        ...
                        // System.out.println("*****CHILD: " + childLink);
